...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { course_id: @classroom.course_id, period: @classroom.period, teacher_id: @classroom.teacher_id }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { course_id: @classroom.course_id, period: @classroom.period, teacher_id: @classroom.teacher_id }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
